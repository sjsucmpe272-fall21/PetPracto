...
const VetHome = () => {
  ...
  const getVetProfile = async (e) => {
    const res = await axios.get(`http://localhost:3030/Vet/vetDetails/profile/61a403f63dc19fc6094d71af`)
    console.log("res", res)
    setVetData(res.data)
  }
    ...
    <div>
      ...
      <div style={{ textAlign: 'left', padding: '50px' }}>
        ...
        <div style={{ display: "flex", width: "40%", justifyContent: "space-between" }}>
          <div>
            <img width="200px" src="https://media.istockphoto.com/photos/vet-picture-id530783619?k=6&m=530783619&s=170667a&w=0&h=Qq83zMu9fRAuEjjpElhXLy9bkGMRXOPVUA5uFwz4IxI=" alt="" />
          </div>
          <div>
            {/* <p>
